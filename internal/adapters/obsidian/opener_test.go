...
func TestBuildURI(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantURI:   "obsidian://open?vault=MyVault&file=S01.11.15+Theatre%2FREADME.md",
			wantErr:   false,
		},
		{
			...
			wantURI:   "obsidian://open?vault=MyVault&file=S01+Me%2FS01.10-19+Lifestyle%2FS01.11+Entertainment%2FS01.11.15+Theatre%2FREADME.md",
			wantErr:   false,
		},
		{
			...
			wantURI:   "obsidian://open?vault=My+Vault&file=notes%2FREADME.md",
			wantErr:   false,
		},
		{
